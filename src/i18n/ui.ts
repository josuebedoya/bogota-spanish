...
export const ui = {
  "en-US": {
    ...
    'footer.newsletter.subtitle': 'Enter your mail address to get our updates, offer and study abroad               related all updates',
    'footer.newsletter.form.input': 'Enter your email...',
