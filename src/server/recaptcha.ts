import { SECRET_RECAPTCHA_KEY as KEY, SECRET_RECAPTCHA_PROJECT_ID as ID } from 'astro:env/server'
...
export async function createAssessment({
  ...
  const projectPath = client.projectPath(ID);
  ...
  if (response.tokenProperties.action === recaptchaAction) {
    ...
    console.log('RESPONSE Captcha:', response.riskAnalysis.score);
